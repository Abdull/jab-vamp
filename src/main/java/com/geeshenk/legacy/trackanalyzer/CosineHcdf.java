...
public class CosineHcdf extends Segmentation {
	...
	@Override
	public ArrayList<Float> getRateOfChange(Chromagram ch, ApplicationParameters params) {
		int hops = ch.getHops();
		int bins = ch.getBins();
	...
	@Override
	public ArrayList<Integer> getSegments(ArrayList<Float> rateOfChange, ApplicationParameters params) {
		// Pick peaks
