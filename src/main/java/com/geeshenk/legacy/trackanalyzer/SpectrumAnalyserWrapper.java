...
class SpectrumAnalyserWrapper {
	...
	public SpectrumAnalyserWrapper(int f, ApplicationParameters p, SpectrumAnalyser s) {
		frate = f;
		params = p;
		sa = s;
	}
	...
	public ApplicationParameters chkParams() {
		return params;
	}
...
class SpectrumAnalyserFactory {
	...
	public SpectrumAnalyser getSpectrumAnalyser(int f, ApplicationParameters p) throws Exception {
		factoryMutex.lock();
		try {
