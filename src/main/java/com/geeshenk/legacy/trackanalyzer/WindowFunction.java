...
public abstract class WindowFunction {
	...
	public static WindowFunction getWindowFunction(ApplicationParameters.temporal_window_t w) {
		if (w == ApplicationParameters.temporal_window_t.WINDOW_HANN) {
			return new HannWindow();
		} else if (w == ApplicationParameters.temporal_window_t.WINDOW_HAMMING) {
