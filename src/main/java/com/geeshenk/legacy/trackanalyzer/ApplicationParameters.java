...
public class ApplicationParameters {
	 ...
	 */
	public static String camelotKey(ApplicationParameters.key_t key) {
		return ApplicationParameters.camelot_key[key.ordinal()];
	}
	...
	public boolean equivalentForSpectralAnalysis(ApplicationParameters that) {
