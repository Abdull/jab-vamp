...
public class FftwAnalyser extends SpectrumAnalyser {
	...
	public FftwAnalyser(int f, ApplicationParameters params) throws Exception {
		super(f, params);
	...
	@Override
	public Chromagram chromagram(WaveAudioSpecificationsAndData audio) throws Exception {
		analyserMutex.lock();
		try {
