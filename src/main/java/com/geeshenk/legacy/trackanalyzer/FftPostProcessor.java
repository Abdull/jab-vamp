...
public abstract class FftPostProcessor {
	...
	public static FftPostProcessor getFftPostProcessor(int fr, ApplicationParameters params) throws Exception {
		return new DirectSkPostProc(fr, params);
	}

	public FftPostProcessor(int fr, ApplicationParameters params) throws Exception {
		if (fr < 1) 
