...
public abstract class Segmentation {
	...
	public static Segmentation getSegmentation(ApplicationParameters params) {
		
		if (params.getSegmentation() == ApplicationParameters.segmentation_t.SEGMENTATION_COSINE) {
	...
	public abstract ArrayList<Float> getRateOfChange(Chromagram ch, ApplicationParameters params);

	public abstract ArrayList<Integer> getSegments(ArrayList<Float> a, ApplicationParameters params);
}
