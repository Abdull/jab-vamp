...
import com.geeshenk.legacy.trackanalyzer.ApplicationParameters.tone_profile_t;
...
public class ToneProfile {
	...
	public ToneProfile(tone_profile_t whichProfile, boolean majorScale, ApplicationParameters params) {
